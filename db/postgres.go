...
func (p db) OpenConnection() Actions {
    var err error
	Postgres.DB, err = sqlx.Connect("postgres", os.Getenv("POSTGRES_CREDENTIALS"))
	if err != nil {
...
func (p db) GetFoods(id string, foods *[]models.Food) {
